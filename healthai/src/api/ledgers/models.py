...
class HealthAILedgerEntryModel(Base):
    ...
    operation: Mapped[HealthAILedgerOperation] = mapped_column(
        Enum(HealthAILedgerOperation), nullable=False
    )
    ...
    def __repr__(self) -> str:
        return f"<HealthAILedgerEntry(id={self.id}, operation={self.operation}, amount={self.amount}{self.currency}, category={self.category}, status={self.status})>"
